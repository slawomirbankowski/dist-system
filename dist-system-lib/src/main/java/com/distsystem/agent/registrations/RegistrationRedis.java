 ...
 * */
public class RegistrationRedis extends RegistrationBase {

    /** local logger for this class*/
    protected static final Logger log = LoggerFactory.getLogger(RegistrationRedis.class);

    /** DAO to MongoDB */
    // private DaoElasticsearchBase elasticDao;

    public RegistrationRedis(ServiceObjectParams params) {
        super(params);
    }
