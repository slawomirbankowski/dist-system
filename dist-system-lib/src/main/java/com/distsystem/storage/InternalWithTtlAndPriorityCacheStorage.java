...
public class InternalWithTtlAndPriorityCacheStorage extends CacheStorageBase {
  private static final Logger log = LoggerFactory.getLogger(InternalWithTtlAndPriorityCacheStorage.class);
  ...
  public InternalWithTtlAndPriorityCacheStorage(Cache cache) {
    super(cache);
