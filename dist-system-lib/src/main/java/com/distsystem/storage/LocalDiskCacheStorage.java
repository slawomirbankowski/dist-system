 ...
 * */
public class LocalDiskCacheStorage extends CacheStorageBase {

    protected static final Logger log = LoggerFactory.getLogger(LocalDiskCacheStorage.class);
    private String filePrefixName;

    /** init local disk storage */
    public LocalDiskCacheStorage(Cache cache) {
        super(cache);
